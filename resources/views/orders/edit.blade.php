...
<body style="font-size: .6rem; background-color: #1b262d;">
    <div class="container" id="app" style="max-width: 800px;">
    	<main class="py-4">
		    <form method="post" action="/orders/replaceorder" enctype="multipart/form-data">
			{{ csrf_field() }}
			...
			<div class="form-group">
				...
				<input type="hidden" class="form-control" id="order_id" name="order_id" aria-describedby="order_id" placeholder="Order_id" value="{{$order_id}}">
				<input type="hidden" class="form-control" id="order_type" name="order_type" aria-describedby="order_type" placeholder="Order_type" value="{{$order_type}}">
			</div>
